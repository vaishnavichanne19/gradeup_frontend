    ...
    <div className='container-fluid'>
      ...
      <div className='row'>
        <div className='col-lg-4 col-md-4 col-sm-12 levelup-img1' data-aos="zoom-in" data-aos-duration="1500">
            <img src={`https://api.gradeup01.in/images/${user.levelupimage1}`}/>
        </div>
        <div className='col-lg-4 col-md-4 col-sm-12 levelup-para'>
            <h1><span style={{color:"#ed0000"}}>{user.heading1}</span> {user.heading} <img src={`https://api.gradeup01.in/images/${user.logo}`} /></h1>
        </div>
        <div className='col-lg-4 col-md-4 col-sm-12 levelup-img2'   data-aos="zoom-in" data-aos-duration="1500">
            <img src={`https://api.gradeup01.in/images/${user.levelupimage2}`} />
        </div>
      </div>
          )
        })}
